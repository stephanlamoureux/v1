...
})({"9syfn":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "95d8c7a9513a2103";
...
/*
Before you can start using your custom element, you'll need to register it with the
customElements.define() method. This method takes at least two arguments.

The first is a DOMString you'll use when adding the component to the page, in this case, <footer-component></footer-component>.

The next is the component's class that you created earlier, here, the Footer class.

The optional third argument describes which existing HTML element your custom element inherits properties from, for example, {extends: 'p'}.
*/ customElements.define("footer-component", Footer);

},{}]},["9syfn","4psvf"], "4psvf", "parcelRequire390d")

//# sourceMappingURL=index.513a2103.js.map
