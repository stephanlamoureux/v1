        ...
        async function getArticle() {
          try {
            ...
            function displayMultipleArticles() {
              ...
              // ToastUI Pagination
              const pagination = new (0, _tuiPaginationDefault.default)(
            ...
            /* 0 */ /***/ function (module, exports, __webpack_require__) {
               ...
               */ function extend(target, objects) {
                ...
                for (i = 1, len = arguments.length; i < len; i += 1) {
                  source = arguments[i]
                  for (prop in source)
                    if (hasOwnProp.call(source, prop)) target[prop] = source[prop]
                }
                return target
              }
                ...
                /** @lends View.prototype */ {
                  ...
                  _appendPages: function (viewData) {
                    ...
                    for (i = firstPage; i <= lastPage; i += 1) {
                      if (i === viewData.page)
                        pageItem = util.createElementByTemplate(this._template.currentPage, {
                          page: i,
                        })
                      else {
