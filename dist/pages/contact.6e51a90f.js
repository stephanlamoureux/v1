...
${frame.code}`
    ...
    '3eG7t': [
      function (require, module, exports) {
        ...
        ;(function () {
          ...
          ;(0, _browserDefault.default).init('user_hYeCfF0DkAoQPn3bOS7WR') // user_hYeCfF0DkAoQPn3bOS7WR
        })()
        window.onload = function () {
          document.getElementById('contact-form').addEventListener('submit', function (event) {
            ...
            ;(0, _browserDefault.default).sendForm('contact_service', 'contact_form', this).then(
              function () {
      ...
      {
        '@emailjs/browser': 'kbSqr',
        '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
        'toastify-js': '96k49',
        'toastify-js/src/toastify.css': '943FW',
      },
    ],
    kbSqr: [
      function (require, module, exports) {
      ...
      {
        './methods/init/init': 'lqGq1',
        './methods/send/send': 'm7CoX',
        './methods/sendForm/sendForm': 'a1Cpe',
        '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
      },
    ],
    lqGq1: [
      ...
      { '../../store/store': '3eehJ', '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3' },
    ],
    '3eehJ': [
      function (require, module, exports) {
        var parcelHelpers = require('@parcel/transformer-js/src/esmodule-helpers.js')
    ...
    '3pmzm': [
      ...
      {
        '../models/EmailJSResponseStatus': 'oZ06T',
        '../store/store': '3eehJ',
        '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
      },
    ],
...
//# sourceMappingURL=contact.6e51a90f.js.map
