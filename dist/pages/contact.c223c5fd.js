!(function (a1, b) {
  ...
  var c1 = (function (b2) {
    ...
    b2 = {
      ...
      init: function () {
        o._t = {}
        var a = o._a()
        b2.registerHelper(d1, a),
          (o._u = d1),
          (b2.rootDOMTravelScope = document),
          (b2.Parser = o.Parser),
          (o._v = o._p()),
          (o._w = '')
      },
      ...
      registerNotifier: function (a) {
        ...
        return a.id && a.value && b2.EventSystem.isEventTarget(a.value)
          ? ((c[a.id] = a.value), 1)
          : ''
      },
    ...
    return (
      ...
      (o._d = function (a, c) {
        ...
        if ((c.after && o.Util._x(c.after) && (d = c.after[0]), '' !== e2)) {
          var g2,
            ...
            i2 = 0
          for (i2; h2 > i2; i2++)
            if (((g2 = f2[i2]), b2.EventSystem.isEventTarget(g2))) {
              var j = function (e) {
                var f = o._g(a, c, e),
                  g = o._h(c),
                  h = o._j(a, c),
              ...
              b2.EventSystem.addEventListenerHelper(g2, e2, j, !1),
                b2.EventSystem.registerEventHandle(g2, e2, j)
            }
        }
      }),
      (o._e = function (a) {
      ...
      (o._f = function (c, d) {
        ...
        if (d.eventTarget) {
          ...
          else if ('window' === d.eventTarget) g = [a2]
          ...
          if (a.id && b2.EventSystem.isEventTarget(a.value)) c.push(a.value), b2.registerNotifier(a)
            ...
            for (f; e > f; f++)
              if (((d = notifierIDList[f]), d && ' ' !== d)) {
                ...
                g ||
                  ((g = b2.EventSystem.createEventTarget()),
                  b2.registerNotifier({
                    id: d,
                    value: g,
                  })),
      ...
      (o._p = function () {
        var a = o._r(),
          b = [l1, 'oAnimationEnd', l1, 'webkitAnimationEnd']
        return b[a]
      }),
      (o._q = function () {
        var a = o._r(),
        ...
        ;(c.init = function (a) {
          ...
          (c.doDefaultAction = function (a5, b) {
            ...
            e.eventSystem.addEventListenerHelper(a5, g, function (a) {
              ...
              'holdAnimClass' !== i &&
                '$holdAnimClass' !== i &&
                ((d = a5._ajLastBehavior), d && f.removeClass(a5, d), (a5._ajLastBehavior = b)),
              (a5.offsetWidth = a5.offsetWidth),
              f.addClass(a5, b)
          }),
        ...
        parseDoDefinition: function (a) {
          ...
          if (null !== c) {
            ;(d = c[1]),
              ...
              (doDefinitionArray = null !== doDefinitionArray ? doDefinitionArray.split(e1) : []),
              (a = []),
              (a[0] = d)
      ...
      (o.NodeHelper = {
        addClass: function (a, b) {
          ...
          for (var c = 0, d = b.length; d > c; ++c)
            b[c] &&
              !new RegExp(j1 + b[c] + k1).test(a.className) &&
              (a.className = '' === a.className ? b[c] : a.className.trim() + ' ' + b[c])
        },
        removeClass: function (a, b) {
          b instanceof Array || (b = b.split(' '))
          for (var c = 0, d = b.length; d > c; ++c)
            a.className = a.className.replace(new RegExp(j1 + b[c] + k1), ' ').trim()
        },
  ...
  return (
    ...
    'undefined' == typeof b1 && (a2.AniJS = c1),
    c1
  )
})
