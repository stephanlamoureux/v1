...
})({"jRPG8":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "f60eb079d890cb10";
...
trigger[0].onclick = function() {
    ...
    if (modal[0].classList.contains("show-modal")) // Disable scroll
...
trigger[1].onclick = function() {
    ...
    if (modal[1].classList.contains("show-modal")) // Disable scroll
    body.style.overflow = "hidden";
    else // Enable scroll
    body.style.overflow = "auto";
};
trigger[2].onclick = function() {
    ...
    if (modal[2].classList.contains("show-modal")) // Disable scroll
    body.style.overflow = "hidden";
    else // Enable scroll
    body.style.overflow = "auto";
};
trigger[3].onclick = function() {
    ...
    if (modal[3].classList.contains("show-modal")) // Disable scroll
    body.style.overflow = "hidden";
    else // Enable scroll
    body.style.overflow = "auto";
};
...
},{}]},["jRPG8","4x9yv"], "4x9yv", "parcelRequire390d")

//# sourceMappingURL=projects.d890cb10.js.map
