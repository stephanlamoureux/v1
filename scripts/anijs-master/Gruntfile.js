module.exports = function (grunt) {
	grunt.initConfig({
		uglify: {
			my_target: {
				...
				files: {
					...
					'dist/event_systems/jquery/anijs-jquery-event-system-min.js': [
						'src/event_systems/jquery/anijs-jquery-event-system.js',
					],
					'dist/helpers/scrollreveal/anijs-helper-scrollreveal-min.js': [
		...
		copy: {
			...
			remoteProduction2: {
				src: ['src/event_systems/jquery/anijs-jquery-event-system.js'],
				dest: 'dist/event_systems/jquery/anijs-jquery-event-system.js',
				options: {},
			},
			remoteProduction3: {
				src: ['src/helpers/scrollreveal/anijs-helper-scrollreveal.js'],
				dest: 'dist/helpers/scrollreveal/anijs-helper-scrollreveal.js',
				options: {},
			},
			remoteProduction4: {
				src: ['src/helpers/dom/anijs-helper-dom.js'],
