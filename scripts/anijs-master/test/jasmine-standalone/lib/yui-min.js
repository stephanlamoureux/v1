...
;(function () {
		...
		(e = {
				...
				for (n in e)
					e.hasOwnProperty(n) &&
						...
						i && n == 'modules'
							...
							? S(s, t)
							: n == 'win'
							? ((r[n] = (t && t.contentWindow) || t), (r.doc = r[n] ? r[n].document : null))
							: n != '_yuid' && (r[n] = t))
				a && a._config(e)
			},
			_config: function (e) {
			...
			_init: function () {
				...
				;(r.constructor = YUI),
					...
					(r.config.base = YUI.config.base || r.Env.getBase(r.Env._BASE_RE))
				...
				for (l in v)
					v.hasOwnProperty(l) &&
						...
						o[a.id] ||
							((o[a.id] = !0),
							(u = a.Env._loader),
							u && ((f = u.getModuleInfo(e)), (!f || f.temp) && u.addModule(r, e))))
				return this
			},
					...
					if (!v[e[n]]) {
						...
						if (!i)
							...
							for (h = 0; h < c.Env._missed.length; h++)
								c.Env._missed[h] === r &&
									(c.message('Found: ' + r + ' (was reported as missing earlier)', 'warn', 'yui'),
			...
			use: function () {
				var e = a.call(arguments, 0),
					...
					o = !0
				n.Lang.isFunction(t)
					? (e.pop(), n.config.delayUntil && (t = n._delayCallback(t, n.config.delayUntil)))
					: (t = null),
				...
				return (
					n._loading
						? ((n._useQueue = n._useQueue || new n.Queue()), n._useQueue.add([e, t]))
			...
			_notify: function (e, t, n) {
				if (!t.success && this.config.loadErrorFn) this.config.loadErrorFn.call(this, this, e, t, n)
					...
					this.Env._missed &&
						...
						((t.msg = 'Missing modules: ' + this.Env._missed.join()), (t.success = !1))
				...
				return (
					...
					m && r && o.Loader
						...
						? ((o._loading = !0),
						  ...
						  u._bootstrapping
								? h.add(s)
								: ((u._bootstrapping = !0), o.Get.script(v.base + v.loaderPath, { onEnd: s })))
						: ((w = o._attach(e)), w && T()),
					o
				)
			},
					...
					return (
						...
						o &&
							...
							f &&
								...
								(s.safari = s.webkit),
								/PhantomJS/.test(o) &&
									((f = o.match(/PhantomJS\/([^\s]*)/)), f && f[1] && (s.phantomjs = n(f[1]))),
								/ Mobile\//.test(o) || /iPad|iPod|iPhone/.test(o)
									...
									: ((f = o.match(/NokiaN[^\/]*|webOS\/\d\.\d/)),
									  ...
									  /webOS/.test(o) &&
											...
											f && f[1] && (s.webos = n(f[1]))),
									  / Android/.test(o) &&
											(/Mobile/.test(o) && (s.mobile = 'Android'),
											(f = o.match(/Android ([^\s]*);/)),
								...
								f && f[1]
									...
									: ((f = o.match(/(Chrome|CrMo|CriOS)\/([^\s]*)/)),
									  f && f[1] && f[2]
											...
											: ((f = o.match(/AdobeAIR\/([^\s]*)/)), f && (s.air = f[0])))),
						...
						r &&
							...
							!(s.chrome && s.chrome < 6) &&
							(s.touchEnabled =
								'ontouchstart' in r || ('msMaxTouchPoints' in i && i.msMaxTouchPoints > 0)),
						t ||
							(typeof process == 'object' &&
								process.versions &&
								process.versions.node &&
								((s.os = process.platform), (s.nodejs = n(process.versions.node))),
							(YUI.Env.UA = s)),
						s
					)
				}),
				...
				(s.prototype = {
					...
					_createNode: function (e, t, n) {
						...
						r ||
							...
							(r = o.className === 'a' ? {} : { for: 'htmlFor', class: 'className' }))
					...
					_finish: function () {
						...
						;(r = this._getEventData()),
							e
								? (t.onTimeout && e[e.length - 1].error === 'Timeout' && t.onTimeout.call(n, r),
							...
							: ((s = i._insertCache),
							  ...
							  (r = s[o])
									...
									: ((r = n.head || n.getElementsByTagName('head')[0]),
									  r
											? (r.appendChild(n.createTextNode('')), (s[o] = r.lastChild))
					...
					_insert: function (t) {
						...
						var n = i._env,
							...
							l
						o ||
							(s ? (l = 'script') : !n.cssLoad && a.gecko ? (l = 'style') : (l = 'link'),
							(o = t.node = this._createNode(l, t.attributes, t.doc))),
							s
								? (o.setAttribute('src', t.url),
								  t.async
										? (o.async = !0)
										: (n.async && (o.async = !1), n.preservesScriptOrder || (this._pending = t)))
								: !n.cssLoad && a.gecko
								? (o.innerHTML =
							...
							s && a.ie && (a.ie < 9 || (document.documentMode && document.documentMode < 9))
					...
					_progress: function (e, t) {
						...
						e && ((t.error = e), this.errors.push({ error: e, request: t })),
							...
							t.autopurge &&
								(i._autoPurge(this.options.purgethreshold), i._purgeNodes.push(t.node)),
		...
		function (e, t) {
			...
			r('load', '0', {
				...
				test: function (e) {
					...
					return n && n.style
						? 'MozTransition' in n.style || 'WebkitTransition' in n.style || 'transition' in n.style
						: !1
				},
				...
				r('load', '2', { name: 'dd-gestures', trigger: 'dd-drag', ua: 'touchEnabled' }),
				r('load', '3', {
					name: 'dom-style-ie',
					test: function (e) {
				...
				r('load', '13', { name: 'io-nodejs', trigger: 'io-base', ua: 'nodejs' }),
				r('load', '14', {
				...
				r('load', '16', { name: 'scrollview-base-ie', trigger: 'scrollview-base', ua: 'ie' }),
				r('load', '17', {
					name: 'selector-css2',
					test: function (e) {
						var t = e.config.doc,
				...
				r('load', '19', { name: 'widget-base-ie', trigger: 'widget-base', ua: 'ie' }),
				r('load', '20', {
					name: 'yql-jsonp',
					test: function (e) {
			...
			YUI.Env._cssLoaded || (YUI.Env._cssLoaded = {}),
				...
				(e.Loader.prototype = {
						...
						for (s in w)
							w.hasOwnProperty(s) &&
								...
								t.details &&
									...
									(i = n && n.requires),
									n
										? !n._inspected && r && i.length !== r.length && delete n.expanded
						...
						if (t)
							for (n in t)
								if (t.hasOwnProperty(n)) {
									...
									else if (n === 'aliases') for (r in i) i.hasOwnProperty(r) && f.addAlias(i[r], r)
									else
										n === 'gallery'
											? this.groups.gallery.update && this.groups.gallery.update(i, t)
											: n === 'yui2' || n === '2in3'
											? this.groups.yui2.update && this.groups.yui2.update(t['2in3'], t.yui2, t)
											: (f[n] = i)
								}
						;(o = f.filter),
							b.isString(o) &&
					...
					addGroup: function (e, t) {
						...
						if (e.patterns)
							for (i in e.patterns)
								e.patterns.hasOwnProperty(i) &&
									((e.patterns[i].group = t), (r.patterns[i] = e.patterns[i]))
						if (n)
							for (i in n)
								n.hasOwnProperty(i) &&
									((s = n[i]),
									typeof s == 'string' && (s = { name: i, fullpath: s }),
									(s.group = t),
									r.addModule(s, i))
					},
					addModule: function (t, n) {
						...
						t.defaults ||
							...
							t.skinnable &&
								t.ext &&
								t.temp &&
								((k = this._addSkin(this.skin.defaultSkin, n)), t.requires.unshift(k)),
						...
						if (t.condition) {
							...
							for (i = 0; i < f.length; i++)
								(D = f[i]),
									...
									(_[D][n] = t.condition),
									L && L !== 'after'
										? L === 'instead' && ((t.supersedes = t.supersedes || []), t.supersedes.push(D))
										: ((t.after = t.after || []), t.after.push(D))
						}
						return (
							t.supersedes && (t.supersedes = this.filterRequires(t.supersedes)),
							t.after &&
								((t.after = this.filterRequires(t.after)), (t.after_map = v.hash(t.after))),
							t.configFn &&
								((N = t.configFn(t)),
								N === !1 && (delete this.moduleInfo[n], delete s._renderedMods[n], (t = null))),
							t &&
									...
									for (s = 0; s < i.use.length; s++)
										(o = this.getModule(i.use[s])),
											o && o.use && o.name !== i.name
												? (n = e.Array.dedupe([].concat(n, this.filterRequires(o.use))))
												: n.push(i.use[s])
								else n.push(t[r])
							}
							t = n
					...
					_canBeAttached: function (t) {
						return (
							(t = this.getModule(t)),
							t && t.test
								? (t.hasOwnProperty('_testResult') || (t._testResult = t.test(e)), t._testResult)
								: !0
						)
					},
					getRequires: function (t) {
						...
						t.temp &&
							...
							delete t.expanded),
							(P =
								(!!this.lang && t.langCache !== this.lang) || t.skinCache !== this.skin.defaultSkin)
								...
								for (n in g)
									if (g.hasOwnProperty(n) && !D[n]) {
										;(x = g[n]),
											(S =
												x &&
												((!x.ua && !x.test) || (x.ua && e.UA[x.ua]) || (x.test && x.test(e, T))))
										if (S) {
						...
						if (t.skinnable) {
							...
							if (L && (L[m] || (A && L[A]))) {
								...
								for (n = 0; n < L[O].length; n++)
									(k = this._addSkin(L[O][n], m)), this.isCSSLoaded(k, this._boot) || E.push(k)
							} else
						...
						for (n in t)
							t.hasOwnProperty(n) &&
								...
								o &&
									...
									o.lang && ((a = this.getLangPackName(h, n)), this._addLangPack(null, o, a))))
						;(u = {}),
						...
						for (o in t)
							t.hasOwnProperty(o) &&
								(i[o] ||
									...
									n &&
										((u = n.expound),
										u && ((t[u] = s.getModule(u)), (r = s.getRequires(t[u])), e.mix(t, v.hash(r))),
										(r = s.getRequires(n)),
										e.mix(t, v.hash(r)))))
					},
					...
					getModule: function (t) {
						...
						return (
							s
								? r && s && r.configFn && !s.configFn && ((s.configFn = r.configFn), s.configFn(s))
								: r &&
								  (n.action
										? n.action.call(this, t, i)
										: ((s = this.addModule(e.merge(r, { test: void 0, temp: !0 }), t)),
										  r.configFn && (s.configFn = r.configFn))),
							s
						)
					},
					_rollup: function () {},
					_reduce: function (e) {
						...
						for (t in e)
							if (e.hasOwnProperty(t)) {
								;(i = this.getModule(t)),
									(((this.loaded[t] || w[t]) && !this.forceMap[t] && !this.ignoreRegistered) ||
										(s && i && i.type !== s)) &&
										delete e[t],
									o && o[t] && delete e[t],
									(r = i && i.supersedes)
					...
					_onSuccess: function () {
						...
						;(r = t.onSuccess),
							...
							(o = !i.length),
							r && r.call(t.context, { msg: u, data: t.data, success: o, failed: i, skipped: n }),
							t._finish(u, o)
					},
					...
					_onFailure: function (e) {
						...
						;(n = n.join(',')),
							t && t.call(this.context, { msg: n, data: this.data, success: !1 }),
							this._finish(n, !1)
					},
					_onTimeout: function (e) {
						var t = this.onTimeout
						t &&
							t.call(this.context, { msg: 'timeout', data: this.data, success: !1, transaction: e })
					},
					_sort: function () {
						var e,
							t = this.required,
											...
											if (p.cssMods.length) {
												for (r = 0; r < p.cssMods.length; r++)
													(a = p.cssMods[r].name),
														...
														o.isCSSLoaded(a) && ((o.inserted[a] = !0), delete o.required[a])
												;(o.sorted = []), o._sort()
											}
											;(t = null), o._insert()
										}
					...
					_filter: function (e, t, n) {
						...
						return (
							...
							e &&
								(i && (r = b.isString(s) ? this.FILTER_DEFS[s.toUpperCase()] || null : s),
					...
					resolve: function (e, t) {
						var r = this,
							...
							o
						;(r.skin.overrides || r.skin.defaultSkin !== l || r.ignoreRegistered) &&
							r._resetModules(),
							e && r.calculate(),
							(t = t || r.sorted),
							(o = function (e) {
								if (e) {
									...
									t.async === !1 && (e.async = t.async),
										(i = e.fullpath
											? r._filter(e.fullpath, e.name)
											: r._url(e.path, e.name, t.base || e.base))
									if (e.attributes || e.async === !1)
										(i = { url: i, async: e.async }), e.attributes && (i.attributes = e.attributes)
						...
						for (b = 0, y = t.length; b < y; b++) {
							...
							if (m) {
								...
								;(g.combine = !0),
									typeof m.root == 'string' && (g.root = m.root),
									(d = m.comboBase || d),
									(v = m.comboSep),
									(h = m.maxURLLength)
							} else if (!r.combine) {
							...
							;(c[d] = c[d] || { js: [], jsMods: [], css: [], cssMods: [] }),
								(p = c[d]),
								(p.group = g.group),
								(p.comboSep = v || r.comboSep),
								(p.maxURLLength = h || r.maxURLLength),
								p[g.type + 'Mods'].push(g)
						}
						var w, E, S, x, T, N, C
						for (d in c)
							if (c.hasOwnProperty(d)) {
								...
								for (C in p)
									if (C === a || C === u) {
										;(E = p[C + 'Mods']), (T = [])
										for (b = 0, y = E.length; b < y; b += 1)
											(g = E[b]),
												(N =
													(typeof g.root == 'string' ? g.root : r.root) + (g.path || g.fullpath)),
												T.push(r._filter(N, g.name))
												...
												for (b = 0, y = T.length; b < y; b++)
													w.push(T[b]),
														...
														S.length > h &&
															((N = w.pop()),
															(S = d + w.join(v)),
															s[C].push(r._filter(S, null, p.group)),
															(w = []),
															N && w.push(N))
	...
	YUI.add('yui', function (e, t) {}, '3.17.2', {
		use: [
			'yui-base',
			'get',
			'features',
