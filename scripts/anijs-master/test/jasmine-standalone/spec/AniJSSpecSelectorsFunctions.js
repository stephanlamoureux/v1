    ...
    describe('cuando se usan como selectores (to) [funciones ayudante]', function () {
      describe('y esa funcion es de tipo $parent', function () {
        describe('cuando no recibe parametros', function () {
          beforeEach(function (done) {
            var dataAnijJS =
                'if: click, do: $addClass testingBehavior, to: $parent, after: $afterFunction',
              targetNode
          ...
          it(
            'entonces se devuelve el padre del elemento que es propietario de la' +
              'definicion data-anijs',
            function () {
        ...
        describe('cuando recibe 1 parametro cuyo valor es "target"', function () {
          beforeEach(function (done) {
            var dataAnijJS =
                'if: click, on: #contenedor,do: $addClass testingBehavior, to: $parent target, after: $afterFunction',
              targetNode
        ...
        describe('cuando recibe 1 parametro cuyo valor es algun "selector CSS"', function () {
          beforeEach(function (done) {
            var dataAnijJS =
                'if: click, on: #contenedor,do: $addClass testingBehavior, to: $parent #a-1-2, after: $afterFunction',
              targetNode
          ...
          it(
            'entonces se devuelve los padres de todos los elementos que matchen con' +
              'dicho selector',
            function () {
              expect(AniJSDefaultHelper.parent).toHaveBeenCalled()
      ...
      describe('y esa funcion es de tipo $closest', function () {
        describe('cuando no recibe parametros', function () {
          beforeEach(function (done) {
            var dataAnijJS =
                'if: click, do: $addClass testingBehavior, to: $closest, after: $afterFunction',
              targetNode
          ...
          it(
            'entonces se devuelve "el ancestro mas cercano" del elemento que es propietario de la' +
              'definicion data-anijs',
            function () {
        ...
        describe('cuando recibe 1 parametro cuyo valor es un selector CSS', function () {
          beforeEach(function (done) {
            var dataAnijJS =
                'if: click, on:#contenedor, do: $addClass testingBehavior, to: $closest .a, after: $afterFunction',
              targetNode
          ...
          it(
            'entonces se devuelve "el ancestro mas cercano" de los elementos que matcheen con ' +
              'dicho selector',
            function () {
              expect(AniJSDefaultHelper.closest).toHaveBeenCalled()
        ...
        describe('cuando se reciben 2 parametros cuyos valores son "target" | selector CSS', function () {
          beforeEach(function (done) {
            var dataAnijJS =
                'if: click, on: ul,do: $addClass testingBehavior, to: $closest target | .a, after: $afterFunction',
              targetNode
          ...
          it(
            'entonces se devuelve "el ancestro mas cercano" que matchee con el selector" ' +
        ...
        describe('cuando se reciben 2 parametros cuyos valores son "selector CSS" | selector CSS', function () {
          beforeEach(function (done) {
            var dataAnijJS =
                'if: click, on: ul,do: $addClass testingBehavior, to: $closest ul | .a, after: $afterFunction',
              targetNode
          ...
          it(
            'entonces se devuelve "el ancestro mas cercano que matcheen con el selector" ' +
      ...
      describe('y esa funcion es de tipo $find', function () {
        describe('cuando no recibe parametros', function () {
          beforeEach(function (done) {
            var dataAnijJS =
                'if: click, do: $addClass testingBehavior, to: $find, after: $afterFunction',
              targetNode
          ...
          it(
            'entonces se devuelve "TODOS los elementos descendientes" del elemento que es propietario de la' +
              'definicion data-anijs',
            function () {
        ...
        describe('cuando recibe 1 parametro cuyo valor es "target"', function () {
          beforeEach(function (done) {
            var dataAnijJS =
                'if: click, on:#a-1-2, do: $addClass testingBehavior, to: $find target, after: $afterFunction',
              targetNode
          ...
          it('entonces se devuelve "los elementos descendientes" del elemento que dispara el evento', function () {
            expect(AniJSDefaultHelper.find).toHaveBeenCalled()
        ...
        describe('cuando recibe 1 parametro cuyo valor es algun "selector CSS"', function () {
          beforeEach(function (done) {
            var dataAnijJS =
                'if: click, on: #contenedor,do: $addClass testingBehavior, to: $find #a-1-2, after: $afterFunction',
              targetNode
          ...
          it(
            'entonces se devuelve "los elementos descendientes" de los elementos ' +
              'que matchen con dicho selector',
            function () {
              expect(AniJSDefaultHelper.find).toHaveBeenCalled()
              expect(Y.one('.a-1-2-3').hasClass('testingBehavior')).toBeTruthy()
            }
        ...
        describe('cuando se reciben 2 parametros cuyos valores son "target" | selector CSS', function () {
          beforeEach(function (done) {
            var dataAnijJS =
                'if: click, on: .test,do: $addClass testingBehavior, to: $find target | .a, after: $afterFunction',
              targetNode
          ...
          it(
            'entonces se devuelve "los elementos descendientes" que matchee con el selector" ' +
              'del elemento que dispara el evento',
            function () {
              expect(AniJSDefaultHelper.find).toHaveBeenCalled()
              expect(Y.one('div.a').hasClass('testingBehavior')).toBeTruthy()
        ...
        describe('cuando se reciben 2 parametros cuyos valores son "selector CSS" | selector CSS', function () {
          beforeEach(function (done) {
            var dataAnijJS =
                'if: click, on: ul,do: $addClass testingBehavior, to: $find .a | ul, after: $afterFunction',
              targetNode
          ...
          it(
            'entonces se devuelve "los elementos descendientes que matcheen con el selector" ' +
              'de los elementos que matcheen con el selector CSS',
            function () {
              expect(AniJSDefaultHelper.find).toHaveBeenCalled()
